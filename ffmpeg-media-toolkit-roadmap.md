...
- [ ] Configure npm `bin`.
- [ ] Add Commander CLI.
- [ ] Add `execa` or equivalent process runner.
- [ ] Add Zod validation.
- [ ] Add Vitest.
- [ ] Add formatting/linting.
- [ ] Implement global CLI flags.
...
```bash
npx @cecilialabs/ffmpeg convert file.mp4 --to webm
```
...
Batch processing logic must be generic. There must not be a separate loop implementation for every format pair.
