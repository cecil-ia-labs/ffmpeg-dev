...
const requiredDocs = [
  ...
  "docs/skill-request-examples.md",
];
...
for (const relative of ["getting-started.md", "cli-reference.md", "mcp.md", "pipelines.md", "migration-from-bash.md", "skill-request-examples.md"]) {
